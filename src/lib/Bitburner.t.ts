declare module "Bitburner" {
     ...
     *
     * Use React.createElement to make the ReactElement type, see
     *     {@link https://react.dev/reference/react/createElement#creating-an-element-without-jsx | creating an element without jsx} from the official React documentation.
     */
    ...
    export interface Singularity {
         ...
         * the same as if you were to do it manually.
         *
         * This function will return true if the player’s home computer cores is successfully upgraded, and false
         *     otherwise.
         *
         ...
         *
         *
         * This function will set you to start working at your current job at a specified company at which you are
         *     employed. If you are already in the middle of some “working” action (such as working for a faction,
         *     training at a gym, or creating a program), then running this function will cancel that action.
         *
         ...
         *
         *
         * Performs an immediate check for which factions you qualify for invites from, then returns an array with the
         *     name of all Factions you have outstanding invitations from.
         *
         ...
         *
         *
         * This function will set you to start working for the specified faction. You must be a member of the faction
         *     and that faction must have the specified work type, or else this function will fail. If you are already
         *     in the middle of some “working” action (such as working for a company, training at a gym, or creating a
         *     program), then running this function will cancel that action.
         *
         ...
         *
         *
         * This function will automatically install your Augmentations, resetting the game as usual. If you do not own
         *     uninstalled Augmentations then the game will not reset.
         *
         * @param cbScript - This is a script that will automatically be run after Augmentations are installed (after
         *     the reset). This script will be run with no arguments and 1 thread. It must be located on your home
         *     computer.
         */
    ...
    export interface Hacknet {
         ...
         *
         * @param index - Index/Identifier of Hacknet Node.
         * @param n - Number of levels to purchase. Must be positive. Rounded to nearest integer. Defaults to 1 if not
         *     specified.
         ...
         *
         * @param index - Index/Identifier of Hacknet Node.
         * @param n - Number of times to upgrade RAM. Must be positive. Rounded to nearest integer. Defaults to 1 if
         *     not specified.
         ...
         *
         * @param index - Index/Identifier of Hacknet Node.
         * @param n - Number of cores to purchase. Must be positive. Rounded to nearest integer. Defaults to 1 if not
         *     specified.
         ...
         *
         * @param index - Index/Identifier of Hacknet Node.
         * @param n - Number of cache levels to purchase. Must be positive. Rounded to nearest integer. Defaults to 1
         *     if not specified.
         ...
         *
         * @param index - Index/Identifier of Hacknet Node.
         * @param n - Number of levels to upgrade. Must be positive. Rounded to nearest integer. Defaults to 1 if not
         *     specified.
         ...
         *
         * @param index - Index/Identifier of Hacknet Node.
         * @param n - Number of times to upgrade cores. Must be positive. Rounded to nearest integer. Defaults to 1 if
         *     not specified.
         ...
         *
         * @param index - Index/Identifier of Hacknet Node.
         * @param n - Number of times to upgrade cache. Must be positive. Rounded to nearest integer. Defaults to 1 if
         *     not specified.
    ...
    export interface Bladeburner {
         ...
         * RAM cost: 4 GB
         *
         * This function returns the number of skill points needed to upgrade the specified skill the specified number
         *     of times.
         *
         * The function returns -1 if an invalid skill name is passed in.
         *
    ...
    export interface CodingContract {
         ...
         *
         * @param filename - Filename of the contract.
         * @param host - Host of the server containing the contract. Optional. Defaults to current server if not
         *     provided.
    ...
    export interface Sleeve {
         ...
         * RAM cost: 4 GB
         *
         * Return a boolean indicating whether or not this action was set successfully (false if an invalid action is
         *     specified).
         *
         * @example
         * ```ts
     ...
     * <hr>
     * For (deprecated) .script usage, see:
    ...
    export interface NS {
         ...
         * security level when this function is called. In order to hack a server you must first gain root access to
         *     that server and also have the required hacking level.
         *
         ...
         *
         * Once the grow is complete, $1 is added to the server's available money for every script thread. This
         *     additive
         * growth allows for rescuing a server even after it is emptied.
         *
         * After this addition, the thread count is also used to determine a multiplier, which the server's money is
         *     then multiplied by.
         *
         ...
         *
         * {@link NS.growthAnalyze | growthAnalyze} can be used to determine the number of threads needed for a
         *     specified multiplicative portion of server growth.
         *
         * To determine the effect of a single grow, obtain access to the Formulas API and use
         * {@link HackingFormulas.growPercent | formulas.hacking.growPercent}, or invert
         ...
         * level to run the command. It also raises the security level of the target server based on the number of
         *     threads. The security increase can be determined using
         *     {@link NS.growthAnalyzeSecurity | growthAnalyzeSecurity}.
         *
         * @example
         * ```js
         ...
         *
         * Like other basic hacking analysis functions, this calculation uses the current status of the player and
         *     server. To calculate using hypothetical server or player status, obtain access to the Formulas API and
         *     use {@link HackingFormulas.hackPercent | formulas.hacking.hackPercent}.
         *
         * @example
         * ```js
         * //For example, assume the following returns 0.01:
         * const hackAmount = ns.hackAnalyze("foodnstuff");
         * //This means that if hack the foodnstuff server using a single thread, then you will steal 1%, or 0.01 of
         *     its total money. If you hack using N threads, then you will steal N*0.01 times its total money.
         * ```
         ...
         *
         * @param threads - Amount of threads that will be used.
         * @param hostname - Hostname of the target server. The number of threads is limited to the number needed to
         *     hack the server's maximum amount of money.
         ...
         * Like other basic hacking analysis functions, this calculation uses the current status of the player and
         *     server. To calculate using hypothetical server or player status, obtain access to the Formulas API and
         *     use {@link HackingFormulas.hackChance | formulas.hacking.hackChance}.
         *
         * @param host - Hostname of the target server.
         ...
         * RAM cost: 1 GB
         *
         * This function returns the total decimal number of {@link NS.grow | grow} threads needed in order to multiply
         *     the money available on the specified server by a given multiplier, if all threads are executed at the
         *     server's current security level, regardless of how many threads are assigned to each call.
         *
         * Note that there is also an additive factor that is applied before the multiplier. Each {@link NS.grow |
         *     grow} call will add $1 to the host's money for each thread before applying the multiplier for its thread
         *     count. This means that at extremely low starting money, fewer threads would be needed to apply the same
         *     effective multiplier than what is calculated by growthAnalyze.
         *
         * Like other basic hacking analysis functions, this calculation uses the current status of the player and
         *     server. To calculate using hypothetical server or player status, obtain access to the Formulas API and
         *     use {@link HackingFormulas.growThreads | formulas.hacking.growThreads}.
         *
         * @example
         * ```js
         ...
         * ```
         * @param host - Hostname of the target server.
         * @param multiplier - Multiplier that will be applied to a server's money after applying additive growth.
         *     Decimal form.
         * @param cores - Number of cores on the host running the grow function. Optional, defaults to 1.
         * @returns Decimal number of grow threads needed for the specified multiplicative growth factor (does not
         *     include additive growth).
         */
         ...
         *
         * @param threads - Amount of threads that will be used.
         * @param hostname - Optional. Hostname of the target server. If provided, security increase is limited by the
         *     number of threads needed to reach maximum money.
         ...
         * @returns Returns a string array, where each line is an element in the array. The most recently logged line
         ...
         * @param host - Optional. Hostname of the script being tailed. Defaults to the server this script is running
         *     on. If args are specified, this is not optional.
         ...
         *
         * @param title - The title of the tail window
         * @param pid - Optional. PID of the script having its tail closed. If omitted, the current script is used.
         */
         ...
         * RAM cost: 0.05 GB
         *
         * Running NUKE.exe on a target server gives you root access which means you can execute scripts on said
         *     server. NUKE.exe must exist on your home computer.
         *
         * @example
         * ```js
         * ns.nuke("foodnstuff");
         ...
         *     will run ‘foo.js’ single-threaded with no arguments: ns.run("foo.js");
         *
         * //The following example will run ‘foo.js’ but with 5 threads instead of single-threaded:
         * ns.run("foo.js", {threads: 5});
         *
         * //This next example will run ‘foo.js’ single-threaded, and will pass the string ‘foodnstuff’ into the script
         *     as an argument: ns.run("foo.js", 1, 'foodnstuff');
         * ```
         ...
         *     are being passed into the new script, then the second argument threadOrOptions must be filled in with a
         *     value.
         ...
         * RAM cost: 1.3 GB
         *
         * Run a script as a separate process on a specified server. This is similar to the function {@link NS.run |
         *     run} except that it can be used to run a script that already exists on any server, instead of just the
         *     current server.
         *
         ...
         *     Threads defaults to 1.
         * @param args - Additional arguments to pass into the new script that is being run. Note that if any arguments
         *     are being passed into the new script, then the third argument threadOrOptions must be filled in with a
         *     value.
         * @returns Returns the PID of a successfully started script, and 0 otherwise.
         */
        exec(
         ...
         * @example
         * ```js
         * //The following example will execute the script ‘foo.js’ with 10 threads and the arguments ‘foodnstuff’ and
         *     90: ns.spawn('foo.js', 10, 'foodnstuff', 90);
         * ```
         ...
         * To instead kill a script using its filename, hostname, and args, see
         *     {@link NS.(kill:2) | the other ns.kill entry}.
         *
         * @example
         * ```js
         ...
         * ```
         * @param files - Filename or an array of filenames of script/literature files to copy. Note that if a file is
         *     located in a subdirectory, the filename must include the leading `/`.
         * @param destination - Hostname of the destination server, which is the server to which the file will be
         *     copied.
         * @param source - Hostname of the source server, which is the server from which the file will be copied. This
         *     argument is optional and if it’s omitted the source will be the current server.
         * @returns True if the file is successfully copied over and false otherwise. If the files argument is an array
         *     then this function will return false if any of the operations failed.
         */
         ...
         * }
         * ```
         * @param host - Host address of the target server. If not specified, it will be the current server’s IP by
         *     default.
        ...
        /**
         * Returns a server object for the given server. Defaults to the running script's server if host is not
         * specified.
         *
         * @remarks
         * RAM cost: 2 GB
         ...
         *     otherwise. ns.fileExists("ftpcrack.exe");
         * ```
         ...
         * @example
         * ```js
         * //The function call will return true if there is a script named foo.js with no arguments running on the
         *     foodnstuff server, and false otherwise: ns.isRunning("foo.js", "foodnstuff");
         *
         * //The function call will return true if there is a script named foo.js with no arguments running on the
         *     current server, and false otherwise: ns.isRunning("foo.js", ns.getHostname());
         *
         * //The function call will return true if there is a script named foo.js running with the arguments 1, 5, and
         *     “test” (in that order) on the joesguns server, and false otherwise: ns.isRunning("foo.js", "joesguns",
         *     1, 5, "test");
         * ```
         ...
         * ```
         * @param ram - Amount of RAM of a potential purchased server, in GB. Must be a power of 2 (2, 4, 8, 16, etc.).
         ...
         * @param ram - Amount of RAM of the purchased server, in GB. Must be a power of 2 (2, 4, 8, 16, etc.). Maximum
         ...
         * @example
         * ```js
         * //The function call will return true if there is any script named foo.js running on the foodnstuff server,
         *     and false otherwise: ns.scriptRunning("foo.js", "foodnstuff");
         *
         * //The function call will return true if there is any script named “foo.js” running on the current server,
         *     and false otherwise: ns.scriptRunning("foo.js", ns.getHostname());
         * ```
         ...
         * @param host - Hostname of target server the script is located on. This is optional. If it is not specified
         *     then the function will use the current server as the target server.
         * @returns Amount of RAM (in GB) required to run the specified script on the target server, and 0 if the
         ...
         * Returns the amount of time in milliseconds it takes to execute the {@link NS.hack | hack} Netscript function
         *     on the target server. The required time is increased by the security level of the target server and
         ...
         * RAM cost: 0.05 GB
         *
         * Returns the amount of time in milliseconds it takes to execute the grow Netscript function on the target
         *     server. The required time is increased by the security level of the target server and decreased by the
         ...
         * RAM cost: 0.05 GB
         *
         * Returns the amount of time in milliseconds it takes to execute the {@link NS.weaken | weaken} Netscript
         *     function on the target server. The required time is increased by the security level of the target server
         *     and decreased by the player's hacking level.
         *
         * @param host - Hostname of target server.
         * @returns Returns the amount of time in milliseconds it takes to execute the {@link NS.weaken | weaken}
         *     Netscript function.
         */
         ...
         * This is the same function that the game itself uses to display numbers. The format also depends on the
         *     Numeric Display settings (all options on the "Numeric Display" options page) To format ram or
         *     percentages, see {@link NS.formatRam | formatRam} and {@link NS.formatPercent | formatPercent}
         *
         * @param n - Number to format.
         * @param fractionalDigits - Number of digits to show in the fractional part of the decimal number. Optional,
         *     defaults to 3.
         * @param suffixStart - How high a number must be before a suffix will be added. Optional, defaults to 1000.
         * @param isInteger - Whether the number represents an integer. Integers do not display fractional digits until
         *     a suffix is present. Optional, defaults to false.
         ...
         * This is the same function that the game itself uses to display ram. The format also depends on the Numeric
         *     Display settings (all options on the "Numeric Display" options page) To format plain numbers or
         *     percentages, see {@link NS.formatNumber | formatNumber} and {@link NS.formatPercent | formatPercent}
         *
         * @param n - Number to format as an amount of ram, in base units of GB (or GiB if that Numeric Display option
         *     is set).
         * @param fractionalDigits - Number of digits to show in the fractional part of the decimal number. Optional,
         *     defaults to 2.
         ...
         * This is the same function that the game itself uses to display percentages. The format also depends on the
         *     Numeric Display settings (all options on the "Numeric Display" options page) To format plain numbers or
         *     ram, see {@link NS.formatNumber | formatNumber} and {@link NS.formatRam | formatRam}
         *
         * @param n - Number to format as a percentage.
         * @param fractionalDigits - Number of digits to show in the fractional part of the decimal number. Optional,
         *     defaults to 2.
         * @param multStart - When to switch the percentage to a multiplier. Default is 1e6 or x1.00m.
         ...
         * @returns True if the player clicks “Yes”; false if the player clicks “No”; or the value entered by the
         *     player.
         */
        prompt(
            txt: string,
         ...
         *
         * In NetscriptJS, you must preface any call to wget with the await keyword (like you would
         *     {@link NS.hack | hack} or {@link NS.sleep | sleep}). wget will still work in Netscript 1.0, but the
         *     function's execution will not be synchronous
         ...
         * @example
         * ```js
         * await ns.wget("https://raw.githubusercontent.com/bitburner-official/bitburner-src/master/README.md",
         *     "game_readme.txt");
         * ```
         ...
         * RAM cost: 0 GB
         *
         * @param name - The fully-qualified function name, without the leading `ns`. Example inputs: `hack`, `tprint`,
         *     `stock.getPosition`.
         */
...
// CORP ENUMS - Changed to types
    ...
    export interface WarehouseAPI {
         ...
         * @param city - Name of the city
         * @param materialName - Name of the material
         * @param option - smart supply option, "leftovers" to use leftovers, "imports" to use only imported materials,
         *     "none" to not use materials from store
         */
